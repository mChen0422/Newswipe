package com.meitong.newswipe.repository;
...
public class NewsRepository {
    ...
    private final newswipeDatabase database;

    public NewsRepository() {
        newsApi = RetrofitClient.newInstance().create(NewsApi.class);
        database = newswipeApplication.getDatabase();
    }
...
//        return mutableLiveData;
    ...
    private static class FavoriteAsyncTask extends AsyncTask<Article, Integer, Boolean> {
        ...
        private FavoriteAsyncTask(newswipeDatabase database, MutableLiveData<Boolean> liveData) {
